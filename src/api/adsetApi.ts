...
const BASE_URL = "https://www.ritmosp.com.br/ofertas/requestAdset.php";
...
// Funções criadas para realizar a consulta direto para API da Adset. Descontinuada, porque restrições da API
